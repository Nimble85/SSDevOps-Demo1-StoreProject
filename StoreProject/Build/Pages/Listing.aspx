<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listing.aspx.cs" Inherits="StoreProject.Pages.Listing"
...
<asp:Content ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <asp:Repeater ItemType="StoreProject.Models.Game" SelectMethod="GetGames" runat="server">
            <ItemTemplate>
                <div class="item">
                    <h3><%# Item.Name %></h3>
                    <%# Item.Description %>
